...
for noise = [0]
    ...
    %feedback= zeros(1,6);
    %%
    open_system('NeuroControl_Loudspeaker_offline2_LinearFeedplusNN','loadonly')
    sim('NeuroControl_Loudspeaker_offline2_LinearFeedplusNN')
    %
